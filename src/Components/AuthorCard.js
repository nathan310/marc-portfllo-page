      ...
      <div id="intro" class="bg-[#
        3EAEAEA] h-auto my-6 py-8 rounded-lg border-4">
          ...
          <div id="content" class="prose lg:prose-xl px-2">
            <h1 class="text-center text-gray-800 text-4xl capitalize font-medium">Philip Marcus Nathan Jr.</h1>
            <small class="text-center block text-md text-gray-800">Student,  &amp; Software Engineer</small>
