    ...
    return (
        ...
        <div id="navbar">
            ...
            <div classNameName="py-6">
                <main>
                    <div classNameName="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        ...
                        {/* <!-- Work --> */}
                        <div id="intro" classNameName="bg-[#
          3EAEAEA] h-auto my-6 py-8 rounded-lg border-4">
                            <div id="avatar" classNameName="flex justify-center py-2">
                                <img classNameName="w-40" src="https://api.multiavatar.com/JB.svg " alt="JB image" />
                            </div>
                            <div id="content" className="prose lg:prose-xl px-2">
                                <h1 className="text-center text-gray-800 text-4xl capitalize font-medium">Carlos S. Nah</h1>
          ...
          3EAEAEA] h-50 my-6 py-8 rounded-lg border-4"></div>
                        {/* <!-- Hobbies --> */}
                        <div id="hobbie" className="bg-[#B2B2B2] h-50 my-6 py-8 rounded-lg border-4"></div>
                    </div>
                    {/* /En<!--d replace --> */}
                </main>
            </div>
